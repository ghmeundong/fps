...
const weaponBody = new THREE.Mesh(new THREE.BoxGeometry(0.095, 0.105, 0.46), weaponBodyMaterial)
weaponBody.position.z = -0.18
weapon.add(weaponBody)
const weaponSlide = new THREE.Mesh(new THREE.BoxGeometry(0.065, 0.05, 0.46), weaponSlideMaterial)
weaponSlide.position.set(0, 0.09, -0.2)
weapon.add(weaponSlide)
const weaponGrip = new THREE.Mesh(new THREE.BoxGeometry(0.08, 0.25, 0.095), weaponBodyMaterial)
weaponGrip.position.set(0, -0.14, 0.04)
weaponGrip.rotation.x = -0.23
weapon.add(weaponGrip)
const weaponBarrel = new THREE.Mesh(new THREE.CylinderGeometry(0.022, 0.022, 0.24, 12), weaponBodyMaterial)
